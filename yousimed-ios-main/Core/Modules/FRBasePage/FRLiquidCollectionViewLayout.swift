//
//  AZLiquidCollectionViewLayout.swift
//  IamAZone
//
//  Created by Mostafa Gamal on 2020-12-13.
//  Copyright © 2020 MosCD. All rights reserved.
//
import UIKit

public protocol FRLiquidLayoutDelegate: AnyObject {
    func collectionView(collectionView: UICollectionView, heightForCellAtIndexPath indexPath: IndexPath, width: CGFloat) -> CGFloat
    func collectionViewCellWidth(collectionView: UICollectionView) -> CGFloat
}

public class FRCollectionViewFlowLayout: UICollectionViewFlowLayout {
    weak var delegate: FRLiquidLayoutDelegate?
}

public class FRLiquidCollectionViewLayout: FRCollectionViewFlowLayout {
