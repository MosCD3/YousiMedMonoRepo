...
struct AuthAlertSettings {
    //Mandatory
    var message: String
    var targetVc: UIViewController
    
    //Optional
    var alertType: AuthAlertType = .normal
...
protocol AuthAlertServiceProtocol {
    func displayAlert(config: AuthAlertSettings)
}

class AuthAlertService: AuthAlertServiceProtocol {
...
//        }
    ...
    static let shared:AuthAlertService = AuthAlertService()
}
